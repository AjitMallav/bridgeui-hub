      ...
      <div className="mx-auto max-w-7xl px-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-lg bg-gradient-to-br from-purple-600 to-blue-600 text-white font-bold">
              B
            </div>
            ...
            <section className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2 rounded-2xl border border-slate-300 bg-white p-6 shadow-sm">
                ...
                <div className="mt-6 rounded-xl border border-purple-300 bg-purple-50 p-4 text-sm text-purple-900">
                  ✓ Preferences saved locally for this session. The extension
                  demo reads these numbers.
                </div>
              </div>
          ...
          {tab === "help" && (
            <section className="rounded-2xl border border-slate-300 bg-white p-6 shadow-sm">
              ...
              <ol className="mt-2 list-inside list-decimal space-y-1 text-sm text-slate-800">
                ...
                <li>
                  Preset preferences apply instantly; misclicks will “grow”
                  buttons to 96% success (scripted).
                </li>
              </ol>
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <input
            ...
            onChange={e =>
              onChange({ ...prefs, buttonSize: Number(e.target.value) })
            }
...
function ADHDControls({
  ...
  return (
    <div className="grid gap-4">
      <ToggleRow
        label="Reduce motion (limit animations)"
        value={prefs.reduceMotion}
        onChange={v => onChange({ ...prefs, reduceMotion: v })}
      />
      <ToggleRow
        label="Highlight focused element strongly"
        value={prefs.focusHighlight}
        onChange={v => onChange({ ...prefs, focusHighlight: v })}
      />
      <ToggleRow
        label="Hide distracting UI (ads/sidebars) in preview"
...
function DyslexiaControls({
  ...
  return (
    <div className="grid gap-4">
      ...
      />
      <ToggleRow
        label="Underline links for readability"
...
function LowVisionControls({
  ...
  return (
    <div className="grid gap-4">
      <ToggleRow
        label="High-visibility focus ring"
        value={prefs.highVisibilityFocusRing}
        onChange={v => onChange({ ...prefs, highVisibilityFocusRing: v })}
      />
      <div>
        <label className="mb-2 block text-sm font-semibold text-slate-900">
          Global zoom
